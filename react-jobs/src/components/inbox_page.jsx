...
<div className='flex h-full bg-gray-300'>
          ...
          <Navbar/>
<div className= 'overflow-y-auto flex flex-col border border-gray-500 w-70 h-100'>
  <nav className='overflow-y-auto flex flex-col'>
    <div className='border-b border-black hover:bg-gray-500 hover:text-white h-32'>
      <h3 className='italic text-gray-700 mb-0 ml-2'>Contact 1</h3>
        <div className="ml-2">
          ...
          <p className='flex mb-0 text-left'>Hello, I was interested in...</p>
      </div>
    </div>
    <div className='border-b border-black pb-4 hover:bg-gray-500 hover:text-white h-32'>
      <h3 className='italic flex text-gray-700 mb-0 ml-2'>Contact 2</h3>
        <div className="ml-2">
    ...
    <div className='border-b border-black pb-4 hover:bg-gray-500 hover:text-white h-32'>
      <h3 className='italic flex text-gray-700 mb-0 ml-2'>Contact 3</h3>
        <div className="ml-2">
    ...
    <div className='border-b border-black pb-4 hover:bg-gray-500 hover:text-white h-32'>
      <h3 className='italic flex text-gray-700 mb-0 ml-2'>Contact 4</h3>
        <div className="ml-2">
    ...
    <div className='border-b border-black pb-4 hover:bg-gray-500 hover:text-white h-32'>
      <h3 className='italic flex text-gray-700 mb-0 ml-2'>Contact 5</h3>
        <div className="ml-2">
    ...
    <div className='border-b border-black pb-4 hover:bg-gray-500 hover:text-white h-32'>
      <h3 className='italic flex text-gray-700 mb-0 ml-2'>Contact 6</h3>
        <div className="ml-2">
    ...
    <div className='border-b border-black pb-4 hover:bg-gray-500 hover:text-white h-32'>
      <h3 className='italic flex text-gray-700 mb-0 ml-2'>Contact 7</h3>
        <div className="ml-2">
    ...
    <div className='border-b border-black pb-4 hover:bg-gray-500 hover:text-white h-32'>
      <h3 className='italic flex text-gray-700 mb-0 ml-2'>Contact 8</h3>
        <div className="ml-2">
      ...
      <div className='flex flex-col flex-grow'>
          <div className='font-bold bg-gray-400 flex items-center justify-center h-32'>
